import { parseImmediate } from "mips-assembler/dist/js/src/immediates";
import { getSymbolValue } from "mips-assembler/dist/js/src/symbols";
import { unescapeString } from "mips-assembler/dist/js/src/strings";
import { LABEL_CHARS } from "mips-assembler/dist/js/src/labels";
import { abs } from "mips-assembler/dist/js/src/functions/abs";
import { hi } from "mips-assembler/dist/js/src/functions/hi";
import { lo } from "mips-assembler/dist/js/src/functions/lo";
import { org } from "mips-assembler/dist/js/src/functions/org";
