...
import { handleDirective, isConditionalDirective, getDirectiveToRun } from "mips-assembler/dist/js/src/directives";
import { parseGlobalLabel } from "mips-assembler/dist/js/src/labels";
import { getSymbolByValue } from "mips-assembler/dist/js/src/symbols";
import { evaluateExpressionsOnCurrentLine, parseExpressionsOnCurrentLine } from "mips-assembler/dist/js/src/expressions";
import { IfElseStateFlags } from "mips-assembler/dist/js/src/conditionals";
import { makeNewAssemblerState } from "mips-assembler/dist/js/src/state";
